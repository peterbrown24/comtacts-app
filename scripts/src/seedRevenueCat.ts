...
const PROJECT_NAME = "Comt@cts, Inc.";
...
const APP_STORE_APP_NAME = "Comt@cts Inc iOS";
const APP_STORE_BUNDLE_ID = "com.comtacts.inc";
const PLAY_STORE_APP_NAME = "Comt@cts Inc Android";
const PLAY_STORE_PACKAGE_NAME = "com.comtacts.inc";
